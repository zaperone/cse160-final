...
```
```{r}
#CLustering between Salary and Cities, Salary and Rating, Salary and Industry
...
```{r}
df = read.csv("/Users/HoaBui/Documents/Lehigh works/Fall 2020/CSE 160/DataAnalyst.csv")
df
```
...
ggplot(df2, aes(x=data.Location, y=val, fill=type)) + geom_bar(position="stack", stat="identity")
